...
export class LifecycleManager {
  ...
  history(): readonly LifecycleTransitionRecord[] {
    return [...this.#history];
  }

  canTransition(nextState: RuntimeState): boolean {
  ...
  #isValidTransition(currentState: RuntimeState, nextState: RuntimeState): boolean {
