...
import { defaultRuntimeConfig, type RuntimeConfig } from './runtime-config.js';

export class ConfigLoader {
  static load(configPath?: string): RuntimeConfig {
  ...
  static #mergeConfig(base: RuntimeConfig, override: any): RuntimeConfig {
